   ...
   <section className="max-w-screen-2xl mx-auto rounded-md px-4 sm:px-6 ">
    <div class="py-8 px-4 mx-auto flex max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            <a className="flex items-center text-2xl font-semibold text-">
                            <img
            ...
            <Link to='/' class="inline-flex active bg-primary-600 hover:bg-primary-800 text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">Back to Homepage</Link>
        </div>   
    </div>
</section>
 </div>
